...
setup(
    ...
    entry_points={
        "custodian.resources": ['azure = c7n_azure.entry:initialize_azure']
    },
    install_requires=[
    ...
    package_data={
        '': [
            'function_binding_resources/bin/*.dll',
            'function_binding_resources/*.csproj',
            'function_binding_resources/bin/*.json',
        ]
    },
)
